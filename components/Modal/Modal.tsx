...
import { modalState, tweetIdState, tweetState } from "../../atoms/modalAtom";
...
export const Modal: React.FC<ModalProps> = ({ session, onCommentCreated }) => {
                                ...
                                <div className="w-full">
                                    <div className="text-[#6e767d] flex gap-x-3 relative">
                                        ...
                                        <div>
                                            ...
                                            <br />
                                            <span className="hover:underline text-sm sm:text-[15px]">
                                                <a>Répondre à</a> <a className="text-[#1d9bf0]">{tweet?.author?.name}</a>
                                            </span>
                                        </div>
                                    </div>
